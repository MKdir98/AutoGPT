...
class TwoShotAgentPromptConfiguration(SystemConfiguration):
...
class TwoShotAgentPromptStrategy(PromptStrategy):
    default_configuration: TwoShotAgentPromptConfiguration = (
        TwoShotAgentPromptConfiguration()
    )

    def __init__(
        self,
        configuration: TwoShotAgentPromptConfiguration,
        logger: Logger,
    ):
