...
COMMAND_CATEGORY = "hire_agent"
COMMAND_CATEGORY_TITLE = "Hire agent"

@command(
    "hire_agent",
    "Hire a new agent member for someone. The prompt for this step should be create someone to do this task.",
    {
        "prompt": JSONSchema(
...
async def hire_agent(prompt: str, role:str, agent: AgentMember, boss_id: str) -> str:
    """Hire new agent for some one
